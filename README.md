...
[link to delete-all-printers.sh](https://github.com/MoserMichael/myenv/scripts/delete-all-printers.sh)
```
delete all printers
```
[link to docker-push-repo.sh](https://github.com/MoserMichael/myenv/scripts/docker-push-repo.sh)
```
...
```
[link to find-replace.sh](https://github.com/MoserMichael/myenv/scripts/find-replace.sh)
```
...
```
[link to list-deployments-with-images.sh](https://github.com/MoserMichael/myenv/scripts/list-deployments-with-images.sh)
```
...
```
[link to pod-logs.sh](https://github.com/MoserMichael/myenv/scripts/pod-logs.sh)
```
...
```
[link to record-from-screen-cli.sh](https://github.com/MoserMichael/myenv/scripts/record-from-screen-cli.sh)
```
...
```
[link to scale-deployment.sh](https://github.com/MoserMichael/myenv/scripts/scale-deployment.sh)
```
...
```
[link to size-of-git-repos.sh](https://github.com/MoserMichael/myenv/scripts/size-of-git-repos.sh)
```
4.6M	./.git
```
[link to ssh-big.sh](https://github.com/MoserMichael/myenv/scripts/ssh-big.sh)
```
...
```
[link to ssh-to-node.sh](https://github.com/MoserMichael/myenv/scripts/ssh-to-node.sh)
```
...
```
[link to teenocolor](https://github.com/MoserMichael/myenv/scripts/teenocolor)
```
