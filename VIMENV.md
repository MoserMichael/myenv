...
--      | GitBlame          | runs git blame on the file of the current window; while in the blame window: GitBlame opens another window with the commit that changed the current line.
